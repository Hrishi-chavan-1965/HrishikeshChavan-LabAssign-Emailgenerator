...
public class CredService {
	 ...
	 public char[] generatePassword() 
	 {
		...
		String splchar = "!@#$%^&*";
		String value=capLetters+smallletters+numbers+splchar;
		int i;
		char p[]=new char[8];
       ...
       public void displayEmpDetails(String fname, String sname, String generateEmail, char[] genPwd) {
    	   ...
    	   System.out.println("Emp FirstName is"+sname);
    	   System.out.println("Emp FirstName is"+generateEmail);
    	   System.out.println("Emp FirstName is"+genPwd);
